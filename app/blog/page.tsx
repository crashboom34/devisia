        ...
        <section className="pt-24 pb-12 bg-gradient-dark">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Conseils, guides et actualités pour les professionnels du BTP
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
            <div className="grid md:grid-cols-2 gap-8">
              {blogPosts.map((post) => (
                <Card
                  key={post.id}
                  className="bg-brand-darkCard border-gray-800 hover:border-brand-green/50 transition-all duration-300 hover:-translate-y-1"
                >
                  <CardHeader>
