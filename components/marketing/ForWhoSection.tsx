      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-gray-800 bg-brand-darkCard/60 p-6 shadow-inner shadow-black/30 space-y-3">
              <h3 className="text-xl font-semibold text-white">Artisans solo &amp; auto-entrepreneurs</h3>
              <p>
                Tu gères tout : prospection, chantier, devis, factures. Devisia te permet de sortir des devis propres en
                quelques minutes, même le soir après le chantier, sans te battre avec Excel. Tu gardes tes prix, tes habitudes,
                mais tu sécurises tes marges et ton image auprès des clients.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gray-800 bg-brand-darkCard/60 p-6 shadow-inner shadow-black/30 space-y-3">
              ...
              <p>
                ...
                Devisia, tu centralises ta base de prix et tes modèles pour que toute l’équipe parle le même langage. Tu sais
                qui a envoyé quel devis, à quel client, et tu vois en un coup d’œil ce qui est en attente, accepté ou refusé.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gray-800 bg-brand-darkCard/60 p-6 shadow-inner shadow-black/30 space-y-3">
              ...
              <p>
                ...
                Devisia te permet de piloter plusieurs entités dans le même outil, d’appliquer des règles de prix communes et
                de suivre les volumes de devis, les taux de signature et la rentabilité estimée à l’échelle du groupe.
              </p>
            </div>
          </div>
